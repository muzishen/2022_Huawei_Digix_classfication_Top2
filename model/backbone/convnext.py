...
class ConvNeXt(nn.Module):
    ...
    def _frozen_stages(self):
        ...
        for i in range(0, self.frozen_stage):
            print("stage {} is eval".format(i))
...
if __name__ == '__main__':
    cls = convnext_tiny()
    var = torch.FloatTensor(1, 3, 130, 130)
    cls(var)
    # temp = torch.load('C:/Science/pth/convnext_small_1k_224_ema.pth')
    # for i in temp['model']:
    #     print(i)
